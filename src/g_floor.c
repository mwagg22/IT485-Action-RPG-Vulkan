...
void init_floor_ent(Entity *self, int ctr, Entity *ents){
	...
	if (ctr == 0){
		...
		TextLine assetname;
		snprintf(assetname, GFCLINELEN, "../models/%s_%06i.obj", "//other//level//grass//grass//grass", 0);
	...
	if (ctr == 6){
		self->model = gf3d_model_load_animated("//other//level//cave//cave", "//other//level//cave", 0, 1);
		//load_terrain_data("../models//other//level//grass//grass//grass.obj");
	}
	//quadt quad_terrain2;
